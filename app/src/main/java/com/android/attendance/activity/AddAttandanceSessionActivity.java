...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "CSE","IT","ECE","EEE","Mech","Civil"};
	private String[] yearString = new String[] {"FirstY","SY","TY","FY"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit=(Button)findViewById(R.id.buttonsubmit2);
		...
		submit2=(Button)findViewById(R.id.buttonsubmit);
		submit2.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent att = new Intent(AddAttandanceSessionActivity.this,AddAttandanceExcelActivity.class);
				startActivity(att);
			}
		});
	}
